...
#let zh-names = (
  ...
  "J.K.罗琳（女）",
  "乔治·R.R.马丁",
  "巴勃罗·迭戈·何塞·弗朗西斯科·德·保拉·胡安·尼波穆切诺·玛丽亚·德·洛斯·雷梅迪奥斯·西普里亚诺·德·拉·圣蒂西马·特林尼达·鲁伊斯·毕加索（武装直升机）",
)
...
- `inner-gap` (default `1em`): Gap between the surname / given name / honorific parts of a Japanese name. (日文名字中姓、名、敬称之间的间距，默认为 `1em`。)
